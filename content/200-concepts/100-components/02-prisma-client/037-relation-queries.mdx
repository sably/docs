...
For example, the following query returns a list of titles of the unpublished posts associated with each user:
...
You can also write another query using `include` as follows:
